    ...
    <div className="min-h-screen bg-pink-50 flex flex-col">
      <div className="container mx-auto px-4 py-8 max-w-4xl flex-grow flex flex-col">
        <header className="text-center mb-10">
          ...
          <p className="text-xl text-pink-400">Choose your manufacturing method</p>
        </header>

        <div className="flex justify-between mb-8">
          <div className="flex-1 text-center px-4">
            <div className="w-10 h-10 rounded-full bg-pink-500 text-white flex items-center justify-center mx-auto mb-2 font-bold">1</div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg mb-8 flex-grow">
          <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Select Service Type</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-pink-500 mb-2">3D Printing</h3>
                <p className="text-gray-800 mb-4">Create complex three-dimensional objects from digital models with precision and customization.</p>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-pink-500 mb-2">Laser Cutting</h3>
                <p className="text-gray-800 mb-4">Precise cutting or engraving of flat materials with clean edges and intricate details.</p>
                <ul className="text-sm text-gray-700 space-y-1">
